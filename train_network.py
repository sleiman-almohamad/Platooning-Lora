...
class NetworkTrainer:
    ...
    def train(self, args):
        ...
        # TODO remove `hasattr`s by setting up methods if not defined in the network
        ...
        # DataLoader: 0 for persistent_workers
        ...
        accelerator.print(
            f"  num validation images * repeats {val_dataset_group.num_train_images if val_dataset_group is not None else 0}"
        )
